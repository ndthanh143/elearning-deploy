...
interface IModalAssignmentStatisticProps {
  isOpen: boolean
  onClose: () => void
  data: Submission[]
}
export const ModalAssignmentStatistic = ({ isOpen, onClose, data }: IModalAssignmentStatisticProps) => {
  ...
  return (
    <CustomModal title='Assignment statistic' isOpen={isOpen} onClose={onClose}>
